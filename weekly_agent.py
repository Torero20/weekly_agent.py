"""
Weekly ECDC Agent – robust CDTR picker
--------------------------------------
...
Diseñado para GitHub Actions con SMTP (app password). También funciona local.

ENV esperadas (sensibles como Secrets; otras como Variables):
...
# Traducción (googletrans si está; si no, deja el texto tal cual)
...
class WeeklyReportAgent:
    ...
    def summarize_text(self, text: str) -> str:
        if not text:
            return ""
        snippet = text[:20000]  # limite de coste
